...
window.Typekit.config = {
    ...
    , "fi": [139, 140, 171, 173, 175, 5474, 5475, 25136]
    , "fc": [{
        "id": 139
        , "family": "proxima-nova"
        ...
        "id": 171
        , "family": "proxima-nova"
        , "src": "https://use.typekit.net/af/ed0e78/00000000000000003b9b0931/27/{format}{?primer,subset_id,fvd,v}"
        , "descriptors": {
            "weight": "100"
            , "style": "normal"
            , "display": "auto"
        ...
        "id": 5475
        , "family": "proxima-nova"
        , "src": "https://use.typekit.net/af/f02b29/00000000000000003b9b0933/27/{format}{?primer,subset_id,fvd,v}"
        , "descriptors": {
            "weight": "300"
            , "style": "italic"
            , "display": "auto"
    ...
    , "fn": ["proxima-nova", ["i3", "i7", "n1", "n3", "n4", "n5", "n6", "n7"]]
    , "hn": "use.typekit.net"
    , "ht": "tk"
    , "js": "1.19.4"
    , "kt": "jvi8xzm"
...
/*{"k":"1.19.4","auto_updating":true,"last_published":"2017-12-30 23:27:06 UTC"}*/
;
(function (window, document, undefined) {
    ...
    function h(a, b, c) {
        h = Function.prototype.bind && -1 != Function.prototype.bind.toString()
    ...
    da.prototype.b = function (a) {
        for (var b = [], c = 0; c < arguments.length; c++) b.push(arguments[c].replace(/[\W_]+/g, "")
            .toLowerCase());
    ...
    function ia(a) {
        a.length % 4 && (a += Array(5 - a.length % 4)
            .join("="));
        a = a.replace(/\-/g, "+")
            .replace(/\_/g, "/");
    ...
    function H(a, b) {
        return a.b.replace(/\{([^\{\}]+)\}/g, function (a, d) {
            if ("?" == d.charAt(0)) {
                for (var e = d.slice(1)
                        .split(","), f = [], g = 0; g < e.length; g++) b[e[g]] && f.push(e[g] + "=" + encodeURIComponent(b[e[g]]));
    ...
    Ba.prototype.start = function () {
        var a = this.m.g.document
            ...
            , d = new Promise(function (d, e) {
                function k() {
                    l() - c >= b.g ? e() : a.fonts.load(b.b.style + " " + b.b.weight + " 300px " + (b.j ? E(b.b) : b.b.b), b.o)
                        .then(function (a) {
    ...
    if (!window.Typekit.load) {
        var U = new Ha(new G("//" + (window.Typekit.config || {})
            .hn + "/{id}.js"), Ma);
